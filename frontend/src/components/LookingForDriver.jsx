...
const LookingForDriver = (props) => {
  ...
  return (
    <div>
          <h3 className='text-2xl font-semibold mb-5 -mt-6'>Looking for a Driver</h3>
          <div className='flex gap-2 flex-col justify-between items-center'>
            ...
            <button onClick={buttonClickHandler} className='w-full mt-5 bg-red-600 text-white font-semibold p-2 rounded-lg'>Cancel Ride</button>
          </div>
    </div>
  )
}
